    ...
    return (<div className="flex justify-center items-center min-h-screen bg-gray-300">
        <div className="bg-white shadow-lg rounded-lg p-8 max-w-lg w-full transform transition duration-300 hover:scale-105 hover:shadow-2xl hover:bg-gray-50">
          ...
          <form onSubmit={handleUpdate} className="space-y-6">
            ...
            <div className="relative z-0 w-full group">
              <input onChange={(e) => setsolde(e.target.value)} type="number" value={solde || 0} className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="Solde" />
