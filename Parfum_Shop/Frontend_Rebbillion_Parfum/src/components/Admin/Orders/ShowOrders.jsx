...
export default function ShowOrders(){
    ...
    return(
        ...
        <Titlepage role={'Admin'} page={'Orders'} />
            ...
            <CartInfo Title1={'Pending Orders'} Value1={ordersall.filter(e => e.status === 'pending').length}
              Title2={'Completed Orders'} Value2={ordersall.filter(e => e.status === 'completed').length}
               Title3={'Canceled Orders'} Value3={ordersall.filter(e => e.status === 'canceled').length}
               />
