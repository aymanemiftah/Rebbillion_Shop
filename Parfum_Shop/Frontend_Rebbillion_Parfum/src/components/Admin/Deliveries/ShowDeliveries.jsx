...
export default function ShowDeliveries(){
    ...
    const{deliveries,deliveriesall,UpdateDelivery}=useContext(DonnerContext)
    ...
    return(<>
        <div className="bg-gray-100 min-h-screen rounded-lg p-8">
            ...
            <Titlepage role={'Admin'} page={'Deliveries'} />
            ...
            <CartInfo Title1={'Pending Deliveries'} Value1={deliveriesall.filter((e)=>e.delivery_status === 'pending').length}
              Title2={'Shipped Deliveries'} Value2={deliveriesall.filter((e)=>e.delivery_status === 'shipped').length}
               Title3={'Delivered Deliveries'} Value3={deliveriesall.filter((e)=>e.delivery_status === 'delivered').length}
               />
